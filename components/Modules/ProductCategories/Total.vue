    ...
    <v-card elevation="5" rounded="lg" class="withbg">
      <v-card-item>
        <div class="d-sm-flex align-center justify-space-between pt-sm-2">
          <v-card-title class="text-h5">Total event categories</v-card-title>
        </div>
        <v-row>
          <v-col cols="12">
            <div class="mt-6">
              <h3 class="text-h3 text-center pb-4 text-error">12 categories</h3>
              <div class="mt-1">
                ...
                <span class="text-subtitle-1 ml-2 font-weight-bold"
                  >x events average for each</span
                >
              </div>
            </div>
          </v-col>
